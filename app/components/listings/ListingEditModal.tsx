        ...
        <div className="relative p-4 w-full max-w-md max-h-full">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-4 md:p-5">
              ...
              <h1 className='text-xl font-semibold text-gray-900 dark:text-white'>Off Time</h1>
              <div className="space-y-4">
                {offtimes.map((feature, index) => (
                  ...
                  <div key={"ele" + index} className='flex justify-center items-center'>
                    <input
                      ...
                      }} defaultValue={offtimes[index]} className=" m-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                    <button
                      onClick={() => {
